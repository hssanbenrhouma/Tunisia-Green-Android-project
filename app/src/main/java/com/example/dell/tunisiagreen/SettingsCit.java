 ...
 */
public class SettingsCit extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.settingsanddeclaration);
        ...
        btnConsultDeclar=(Button)findViewById(R.id.btnwelcometodeclarationCit) ;
        btnChangePassRes=(Button)findViewById(R.id.btnPassChangeCit);
        btnSuppCmpRes=(Button)findViewById(R.id.btnSuppCompteCIT);
        btnConsultDeclar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SettingsCit.this, CitoyenDec.class);
    ...
    public void btnClickchangePassCit(View view) {
    ...
    public void btnClickDeleteCmpCit(View view) {
    ...
    class ModifPassCit extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog1 = new ProgressDialog(SettingsCit.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(success1==1)
            {
                Toast.makeText(SettingsCit.this, "Modification done .",
                        Toast.LENGTH_SHORT).show();
            }
            else
            {
                Toast.makeText(SettingsCit.this, "Connection failed !.",
                        Toast.LENGTH_SHORT).show();
            }
        }

    }
    class SupprimCit extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog2 = new ProgressDialog(SettingsCit.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(success2!=0)
            {
                Toast.makeText(SettingsCit.this, "Delete Done.",
                        Toast.LENGTH_SHORT).show();
            }
            else
            {
